...
import DnaPic from "../../../assets/projects/dna-sequence-converter.jpg";
      ...
      <div className="background">
        <motion.figure variants={scaleRightDown} initial="start" animate="end">
          ...
          <Image
            ...
            layout="fill"
            objectFit="cover"
            alt="DNA Sequence Converter image"
            priority
          />
        </motion.figure>
      </div>
        ...
        <div className="wrapper">
          ...
          >
            <div className="punch-text">
              <motion.h1 variants={fadeUp}>DNA Sequence Converter</motion.h1>
            </div>
            <div className="information">
              <motion.span variants={fadeUp}>
                Translates DNA Strings!
              </motion.span>
            </div>
            ...
            <div className="project-buttons">
              ...
              <Link href="https://github.com/charliecatxph/dna-sequence-converter">
