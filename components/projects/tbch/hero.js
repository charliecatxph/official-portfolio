...
import TBCHPic from "../../../assets/projects/tbch.jpg";
        ...
        <div className="wrapper">
          ...
          >
            <div className="punch-text">
              <motion.h1 variants={fadeUp}>TBCH</motion.h1>
            </div>
            <div className="information">
              <motion.span variants={fadeUp}>
                TBCH, To Be Completely Honest. Send messages, anonymously.
              </motion.span>
            </div>
            ...
            <div className="project-buttons">
              ...
              <Link href="https://github.com/charliecatxph/tbch-official-ctx">
