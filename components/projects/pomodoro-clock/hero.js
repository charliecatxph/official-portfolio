...
import PomodoroPic from "../../../assets/projects/pomodoro-clock.png";
        ...
        <div className="wrapper">
          ...
          >
            <div className="punch-text">
              <motion.h1 variants={fadeUp}>Pomodoro Clock</motion.h1>
            </div>
            <div className="information">
              <motion.span variants={fadeUp}>
                Be more productive by utilizing the Pomodoro Technique!
              </motion.span>
            </div>
            ...
            <div className="project-buttons">
              ...
              <Link href="https://github.com/charliecatxph/pomodoro-ctx">
